...
Based on the original ORB_SLAM2 which can be found here: https://github.com/raulmur/ORB_SLAM2

**Authors:** [Raul Mur-Artal](http://webdiis.unizar.es/~raulmur/), [Juan D. Tardos](http://webdiis.unizar.es/~jdtardos/), [J. M. M. Montiel](http://webdiis.unizar.es/~josemari/) and [Dorian Galvez-Lopez](http://doriangalvez.com/) ([DBoW2](https://github.com/dorian3d/DBoW2))

# Modifications in this repository
This repository aims to integrate ORB_SLAM2 fully into ROS by using all of the ROS ecosystem tools namely, rosnode/topic sturcutre, rviz, diagnostics, tfs and other goodies. It mainly interfaces with the original source code without modifying when not needed. More accurate documentation is included in each of the ROS packages inside the repository.

Tested and validated on an autonomous racing vehicle.

### Quickstart
```roslaunch orb_slam2_ros zed_stereo.launch```

or you can use any other of the provided camera configuration and launch files.
