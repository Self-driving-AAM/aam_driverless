...
class ORBState {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('num_closes')) {
        this.num_closes = initObj.num_closes
      }
      else {
        this.num_closes = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [num_closes]
    bufferOffset = _serializer.uint16(obj.num_closes, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [num_closes]
    data.num_closes = _deserializer.uint16(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.num_closes !== undefined) {
      resolved.num_closes = msg.num_closes;
    }
    else {
      resolved.num_closes = 0
    }
