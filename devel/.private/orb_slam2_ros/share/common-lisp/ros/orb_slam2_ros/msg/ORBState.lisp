...
(cl:ensure-generic-function 'num_closes-val :lambda-list '(m))
(cl:defmethod num_closes-val ((m <ORBState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam2_ros-msg:num_closes-val is deprecated.  Use orb_slam2_ros-msg:num_closes instead.")
  (num_closes m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ORBState>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'num_closes)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'num_closes)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ORBState>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'num_closes)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'num_closes)) (cl:read-byte istream))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ORBState>)))
  ...
  "0a1b35f9b2e5df4fa8c6909051734938")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ORBState)))
  "Returns md5sum for a message object of type 'ORBState"
  "0a1b35f9b2e5df4fa8c6909051734938")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ORBState>)))
  ...
  (cl:format cl:nil "Header header~%uint16 state # State from Tracking.h~%uint16 num_closes  # number of loop closure occured~%~%# constants for enum-like access~%uint16 UNKNOWN=0~%uint16 SYSTEM_NOT_READY=1~%uint16 NO_IMAGES_YET=2~%uint16 NOT_INITIALIZED=3~%uint16 MAPPING=4~%uint16 LOCALIZING=5~%uint16 LOST=6~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ORBState)))
  "Returns full string definition for message of type 'ORBState"
  (cl:format cl:nil "Header header~%uint16 state # State from Tracking.h~%uint16 num_closes  # number of loop closure occured~%~%# constants for enum-like access~%uint16 UNKNOWN=0~%uint16 SYSTEM_NOT_READY=1~%uint16 NO_IMAGES_YET=2~%uint16 NOT_INITIALIZED=3~%uint16 MAPPING=4~%uint16 LOCALIZING=5~%uint16 LOST=6~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ORBState>))
  ...
  (cl:list 'ORBState
    ...
    (cl:cons ':num_closes (num_closes msg))
))
